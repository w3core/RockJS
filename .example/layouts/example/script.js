/**
 * Layout script __NAME__
 *
 * All properties that will provided by layout are optional!!!
 *
 * COM structure
 * -------------------
 *
 ...
 * @property title {string|function} CSS selector of DOM node which is presented
 *                          in COM HTML markup or function, that using as
 *                          holder/handler for page title changes
...
function __NAME__ ($R, $O)
 {
  ...
  //this.title = 'h1.title';
  //this.title = function (title, page) {}
 }